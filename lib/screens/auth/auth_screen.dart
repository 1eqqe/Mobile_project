...
import 'package:mobile_project/screens/auth/widgets/input_fields.dart';
import 'package:mobile_project/screens/auth/widgets/submit_button.dart';
            ...
            child: Obx(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        MaterialButton(
                          color: !isLogin.value ? Colors.white : Colors.amberAccent,
                          onPressed: () {
                            isLogin.value = true;
                          },
                          child: Text('Login'),
  ...
  Widget registerWidget() {
    return Column(
      children: [
        ...
        SizedBox(height: 20,),
        SubmitButton(onPressed: () => registrationController.registerWithEmail(),
    title: 'Register',)
      ],
    );
  }
